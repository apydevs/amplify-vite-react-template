                ...
                rounded-[0.5rem] shadow grid grid-cols-1 md:grid-cols-2 mr-4 md:mr-0 `}>
                    ...
                    <div className="flex flex-col col-span-1">
                        <div className="relative flex flex-row space-x-1">
                            <div
                                className="absolute left-0  w-[158px] h-[94px] cardTop-img flex flex-col items-start pl-5 justify-start">
                        ...
                        <div className="px-5">
                            ...
                            <div className=" mt-2 text-xs flex flex-wrap items-center gap-4">
                                <div className="flex items-center gap-2">
                                    <span
                                        className="cursor-pointer text-xs  font-medium leading-none text-gray-900 underline hover:no-underline dark:text-white  ">34.5k views</span>
                                </div>
                                ...
                                <div className="flex items-center gap-1.5">
                                    <svg className="h-3 w-3 text-gray-500 dark:text-gray-400" aria-hidden="true"
                                         xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                         viewBox="0 0 24 24">
                                        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"
                                              strokeWidth="2" d="M3 9h13a5 5 0 0 1 0 10H7M3 9l4-4M3 9l4 4"/>
                                    </svg>
                        ...
                        <div className="flex flex-row justify-between items-center">
                            ...
                            <div className="flex">
                                <div className="mr-4 flex-shrink-0 self-center">
                                    <img src="https://media.rightmove.co.uk/company/clogo_14060_0001.jpeg"
                                         className="max-h-10   bg-white"/>
