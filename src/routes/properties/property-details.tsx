            ...
            <>
                <section className="pt-0 antialiased dark:bg-gray-800 md:pb-8 lg:pt-0 lg:dark:bg-gray-900">
                            ...
                            <div
                                ...
                                <div className="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
                                    <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
                                        <Link
                                            to={`/search/properties/${product.name}/gallery#&gid=ReactGridGallery&pid=2`}>
                                            <img
                                    ...
                                    <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
                                        <Link
                                            to={`/search/properties/${product.name}/gallery#&gid=ReactGridGallery&pid=3`}>
                                            <img
                                ...
                                <div
                                    className="aspect-h-5 aspect-w-4 lg:aspect-h-4 lg:aspect-w-3 sm:overflow-hidden rounded-lg">
                    ...
                    <div className="relative mx-auto max-w-screen-xl px-4  md:mt-28 lg:-mt-32">
                        <div
                            className="border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800 lg:rounded-lg lg:rounded-b-none lg:border lg:p-8 p-4">
                                    ...
                                    <div className="shrink-0 hidden md:block">
                                        <div className="w-36 shrink-0 overflow-hidden rounded-lg">
                                            <img className="h-full w-full object-cover"
                                                 src="	https://media.rightmove.co.uk/company/clogo_14060_0001.jpeg"
                                                 alt=""/>
                                        </div>
                                        <button type="button"
                                                className="mt-2 inline-flex items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-medium text-primary-700 hover:bg-gray-100 dark:text-primary-500 dark:hover:bg-gray-700 lg:w-full">
                                    ...
                                    <div className="mt-4 min-w-0 flex-1 sm:mt-0">
                                        ...
                                        <div className="flex flex-row items-start justify-between">
                                            ...
                                            <span
                                                ...
                                                <span
                                                    className="me-5 h-10 rounded px-2.5 py-0.5 text-xs font-medium text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300">
                                        ...
                                        <div className="flex flex-wrap items-center gap-4">
                                            <div className="flex items-center gap-2">
                                                <a href="#"
                                                   className="cursor-pointer text-sm font-medium leading-none text-gray-900 underline hover:no-underline dark:text-white">34.5k
                                                    views</a>
                                            </div>
                                ...
                                <div className="mt-6 shrink-0 space-y-8 sm:mt-8 lg:mt-0 lg:w-full lg:max-w-xs">
                                    ...
                                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-1">
                                        ...
                                        <div className="sm:hidden">
                                            <p className="text-base font-semibold text-gray-900 dark:text-white lg:mt-4"> Key
                                                Property Points:</p>
                                            <div className="mt-2 space-y-4">
